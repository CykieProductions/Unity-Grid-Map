...
namespace CykieProductions.GridMap
{
    ...
    public class MapIcon : MonoBehaviour
    {
        ...
        Transform player;
        public string MapSceneName { get => MapSystemManager.instance.MapSceneName; }
        ...
        void Start()
        {
            ...
            player = MapSystemManager.instance.GetPlayer();
        ...
        void Update()
        {
            ...
            {
                float cellSize = MapSystemManager.instance.MapGridSize;
            ...
            if (isFullMapOpened)
            {
                ...
                //?if (!InputSystem.PressingSwitch())
                {
                    ...
                    var mov = new Vector3(IInputTracker.Current.HorizontalRaw(), IInputTracker.Current.VerticalRaw(), 0);
        ...
        /// <summary>
        /// Simply returns true by default.
        /// </summary>
        /// <returns></returns>
        public virtual bool ShouldFollowPlayer()
        {
            return true;//? !pController.isBetweenRooms && !RoomController.CurrentRoom || RoomController.CurrentRoom.isMappableRoom
        }
        ...
        public void OpenMap()
        {
            if (!isFullMapOpened)
            {
                MapSystemManager.instance.Pause();
                //?UpdateMarkerAmountText();
            ...
            {
                MapSystemManager.instance.Unpause();
